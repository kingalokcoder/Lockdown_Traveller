...
public class BookSeat extends javax.swing.JFrame {
 ...
 public BookSeat()
 {
    ...
    public BookSeat(ResultSet rs) 
    {
       ...
       try {
            if(rs.next())
            {
                ...
                String tac=rs.getString(4);
                String sleeper=rs.getString(5);
                 System.out.println(fac+" "+sac+" "+tac+" "+sleeper);
                jLabel5.setText(fac);
                jLabel6.setText(sac);
                jLabel7.setText(tac);
                jLabel8.setText(sleeper);
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("No. of seats in first AC");

        jLabel2.setText("No. of seats in second AC");

        jLabel3.setText("No. of seats in third AC");

        jLabel4.setText("No. of seats in Sleeper  Class");
